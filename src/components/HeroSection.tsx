      ...
      <div className="relative z-10 container mx-auto px-4 text-center text-white">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-poppins font-bold leading-tight animate-bounce-in">
            ...
            <span className="block text-gradient bg-gradient-to-r from-accent to-primary-glow bg-clip-text text-transparent">
              Launching Soon 🚀
            </span>
          </h1>
          ...
          <form 
            ...
            className="max-w-md mx-auto animate-bounce-in form-glow p-1 rounded-2xl bg-white/10 backdrop-blur-sm"
            ...
            <div className="flex flex-col sm:flex-row gap-3 p-3">
              <div className="flex-1 relative">
                ...
                <Input
                  ...
                  className="pl-10 bg-white/20 border-white/30 text-white placeholder:text-white/70 focus:bg-white/30 input-glow rounded-xl h-12"
                  required
                />
              </div>
              <Button
                ...
                className="btn-notify h-12 whitespace-nowrap"
              >
                {isSubmitting ? (
